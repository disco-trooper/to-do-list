...
const storage = (() => {
  ...
  function populateProjects(projects, addDummies) {
    if (projects.length == 0 && addDummies != 'false') {
      let toDo1 = factories.todoFactory(
        'Civil process',
        'Learn the civil process',
        '2020-1-14',
        '!!!'
      );
      let toDo2 = factories.todoFactory(
        'Family law',
        'Learn the family law',
        '2020-1-14',
        '!!'
      );
      let toDo3 = factories.todoFactory(
        'Cleanup',
        'Clean the bedroom',
        '2020-1-14',
        '!'
      );
      let toDo4 = factories.todoFactory(
        'Doors',
        'Doors are creaking, gotta fix it',
        '2020-1-14',
        '!!'
      );
